  ...
  */
  ...
  MultiTimeseries = (function(_super) {
    ...
    MultiTimeseries.prototype.limit = function(duration) {
      var name, ts, _ref, _results;
      MultiTimeseries.__super__.limit.call(this, duration);
      _ref = this.lookup;
      _results = [];
      for (name in _ref) {
        ts = _ref[name];
        _results.push(ts.limit(duration));
      }
      return _results;
    };
